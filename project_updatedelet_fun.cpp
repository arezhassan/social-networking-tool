...
public:
    ...
    void eventdelet()
    {
        ...
        else
        {
            ...
            if (head->getdata().month <= lmonth &&
                head->getdata().date <= ldate &&
                head->getdata().b.hour <= lhour&&
               head->getdata().b.minute <= lmin
                )
            {
                deleteFromStart();
            }
            else if (tail->getdata().month <= lmonth &&
                tail->getdata().date <= ldate &&
               tail->getdata().b.hour <= lhour&&
                tail->getdata().b.minute <= lmin
                )
            {
                deleteFromEnd();
            }
            else 
            {
                ...
                while (temp->getnextnode() != NULL)
                {
                    if (temp->getdata().month <= lmonth &&
                        temp->getdata().date <= ldate&&
                        temp->getdata().b.hour <= lhour&&
                        temp->getdata().b.minute <= lmin
                        )
                    {
                        prev->setnextnode(temp->getnextnode());
                        delete temp;
    ...
    void eventprint()
    {
        ...
        else
        {
            ...
            while (temp != NULL)
            {
                    ...
                    cout << temp->getdata().b.hour << " ";
                    cout << temp->getdata().b.minute << " ";
                    cout << temp->getdata().b.second << endl;
...
int main() {
    ...
    students s;
    event a;
    a.seteventname("gando");
    a.setmon(4);
    a.setdate(29);
    a.setTIME(18,02,33);
    s.setevents(a);
    s.setfriends("majid66@gmail.com");
    s.Settimeline("hal all boys i want a boy");
   // a.setmon(12);
    a.setTIME(18, 28, 33);
    a.seteventname("mango");
    s.setevents(a);
    s.deletevents();
    s.getevents();
    s.getfriends();
