  ...
  void upcoming_event() {
   ...
   void change_priority(int a,int b) {
    ...
    void event_delete() {
        ...
        int month[10], day[10], hrs[10], mint[10], sec;
        int size = 0;
        while (true) {
        ...
        for (int i = 0; i < size; i++) {
            if (month[i] <= lmonth &&
                ...
                //of << event_name[i];
                of << event_name[i] << " " << month[i] << " " << day[i] << " " << hrs[i] << " " << mint[i] << " " << sec << endl;
    ...
    void event_delete(string n) {
        ...
        for (int i = 0; i < size; i++) {
            if (name[i] == n) {
                cout << "datab deleted sucessfully" << endl;
                continue;
            }
            else {
